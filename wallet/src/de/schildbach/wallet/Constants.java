...
public final class Constants {
    ...
    public final static class Files {
        ...
        public static final String EXTERNAL_WALLET_KEY_BACKUP = "songcoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

        /** Filename of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP = "songcoin-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final String USER_AGENT = "Songcoin Wallet";
    ...
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET)
            ? "SQw4QwjXPq7rFgFVXAufbpj9zQDJfkfLM8" : null;

    /** Recipient e-mail address for reports. */
    public static final String REPORT_EMAIL = "princy.dave@yahoo.com.au";
    ...
    public static final String SOURCE_URL = "https://github.com/RobertStuff/songcoin-wallet";
    public static final String BINARY_URL = "https://github.com/RobertStuff/songcoin-wallet/releases";
